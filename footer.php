...
?>
	...
	<footer id="footer" role="contentinfo">
						...
						<div class="footer-social">
							<ul>
								<li class="icon-social icon-facebook hvr-grow">
									<a class="" href=""><svg class="icon" viewBox="0 0 877.7150599161796 1024">
								...
								<a href="">	<svg class="icon" viewBox="0 0 877.7143758137245 1024">
								...
								<li class="icon-social icon-youtube hvr-grow">
									<a href=""><svg class="icon" viewBox="0 0 877.7149772644043 1024">
		...
		<div id="copyright" class="container">
			<div class="row">
				<div class="col-md-12">
					Copyright &copy; <?php echo date("Y"); ?> <?php bloginfo('name'); ?> Todos os direitos reservados.
				</div>
			</div>
		</div>
	</footer><!-- #footer -->
